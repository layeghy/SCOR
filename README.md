# SCOR: Software-defined Constrained Optimal Routing (SCOR)
**SCOR: Software-defined Constrained Optimal Routing (SCOR)** is a northbound interface for Software Defined Networking (SDN), which can be used with any SDN controller.
